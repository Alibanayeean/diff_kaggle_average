...
class Pipeline(StableDiffusionPipeline):
    ...
    def __call__(
        ...
        objects = [prompt.split()[i - 1] for i in indices_to_alter]
        print(objects)
        _, prompt_embeds_2 =self._encode_prompt(
                prompt,
                device,
                num_images_per_prompt,
                do_classifier_free_guidance,
        ...
        avg_prompt_embeds = None
        for o in objects:
            _, pe = self._encode_prompt(
                o,
                device,
                num_images_per_prompt,
                do_classifier_free_guidance,
                ...
                prompt_embeds=prompt_embeds,
                negative_prompt_embeds=negative_prompt_embeds,)
            if avg_prompt_embeds == None:
                avg_prompt_embeds = pe
            else:
                avg_prompt_embeds = avg_prompt_embeds + pe
        ...
        prompt_embeds = avg_prompt_embeds
